...
public:
    enum Direction {
        Direction_In  =  Masari::TransactionInfo::Direction_In,
        Direction_Out =  Masari::TransactionInfo::Direction_Out,
...
private:
    explicit TransactionInfo(Masari::TransactionInfo * pimpl, QObject *parent = 0);
private:
    friend class TransactionHistory;
    Masari::TransactionInfo * m_pimpl;
